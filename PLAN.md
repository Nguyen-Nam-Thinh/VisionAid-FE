...
- Màn: /auth/register, /auth/recover, /auth/reset, /profile. Reuse AuthPage/useAuth; mock reset(code,password) KHÔNG đủ cho BE cần email, token, newPassword: sửa contract có chủ đích và giữ mock chạy được.
